                ...
                <CardContent>
                    <form onSubmit={submit} className="grid gap-3">
                        <div className="grid gap-3 md:grid-cols-2">
                            ...
                            <label className="grid gap-1 text-base"><span className="font-medium">Banque</span><SearchableSelect value={data.banque} onChange={(value) => setData('banque', value)} options={banques} placeholder="Banque" /></label>
                            ...
                            <label className="grid gap-1 text-base"><span className="font-medium">Montant</span><Input type="number" value={data.montant} onChange={(e) => setData('montant', e.target.value)} /></label>
