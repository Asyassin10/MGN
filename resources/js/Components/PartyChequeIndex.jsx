...
export default function PartyChequeIndex({ title, routeName, ownerKey, ownerLabel, ownerColumn, owners, cheques, filters, banques }) {
    ...
    const columns = [
        ...
        { key: 'facture_recue', label: 'Facture reçue', render: (r) => <InvoiceReceiptSelect value={r.facture_recue} onChange={(value) => router.patch(route(`${routeName}.status`, r.id), { facture_recue: value }, { preserveScroll: true })} /> },
