...
class ArticleDetailsTest extends TestCase
{
    ...
    public function test_new_article_has_no_depot_stock_and_can_be_deleted(): void
    {
        Depot::create(['name' => 'Dépôt A']);
        Depot::create(['name' => 'Dépôt B']);
        $admin = User::factory()->create(['role' => 'admin']);
        ...
        $this->assertSame([], $article->depots()->pluck('depots.id')->all());
